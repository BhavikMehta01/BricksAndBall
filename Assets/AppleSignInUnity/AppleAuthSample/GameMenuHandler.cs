...
/*    public Text AppleUserIdLabel;
    ...
    public void SetupAppleData(string appleUserId, ICredential receivedCredential)
    {
       // this.AppleUserIdLabel.text = "Apple User ID: " + appleUserId;
        ...
        {
           // UserName.text = appleIdCredential.FullName.ToString();
            //EmailID.text = appleIdCredential.Email;
...
*/
            if (appleIdCredential.IdentityToken != null)
            {
             ...
             /*   stringBuilder.AppendLine("<b>Identity token (" + appleIdCredential.IdentityToken.Length + " bytes)</b>");
                ...
                //PreferenceManager.instance.SetUseridentityToken(identityToken);
            }

            Debug.Log("UserId: "+ appleIdCredential.User);
            PreferenceManager.instance.SetUseridentityToken(appleIdCredential.User);
  ...
  */
            Debug.Log("EmailID" + appleIdCredential.Email);
            if (appleIdCredential.Email != null)
            {
                ...
                Debug.Log(" Emial - " + appleIdCredential.Email);
                if(EmailID) EmailID.text = appleIdCredential.Email;

                PreferenceManager.instance.SetUserEmail(appleIdCredential.Email.ToString());
            }
            ...
            if (appleIdCredential.FullName != null)
            {
               ...
               /* stringBuilder.AppendLine();
                ...
                if(UserName) UserName.text = fullName.ToLocalizedString();

                PreferenceManager.instance.SetUserName(fullName.ToLocalizedString());
                if (appleIdCredential.FullName.PhoneticRepresentation != null)
                {
                   ...
                   /* stringBuilder.AppendLine("<b>Phonetic name:</b> " + phoneticName.ToLocalizedString());
                    ...
                    Debug.Log(" phoneticName - " + phoneticName);
                }
            }
